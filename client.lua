...
Citizen.CreateThread(function()
    while true do
        ...
        SendNUIMessage({
            ...
            idplayer = GetPlayerServerId(NetworkGetEntityOwner(GetPlayerPed(-1))),
...
RegisterNetEvent('esx_aparatcity-hud:updateStatus')
AddEventHandler('esx_aparatcity-hud:updateStatus', function(status)
	SendNUIMessage({action = "updateStatus", status = status})
end)

RegisterNetEvent('esx_aparatcity-hud:updateWeight')
AddEventHandler('esx_aparatcity-hud:updateWeight', function(weight)
